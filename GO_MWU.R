##code for gene ontology enrichment analyses associated with Changsut et al. 2023##
##just basically the same as the basic from github##
...
input="Count_Int_filtered_GOMWU.csv" # two columns of comma-separated values: gene id, continuous measure of significance. To perform standard GO enrichment analysis based on Fisher's exact test, use binary measure (0 or 1, i.e., either sgnificant or not).
goAnnotations="annos.tab" # two-column, tab-delimited, one line per gene, multiple GO terms separated by semicolon. If you have multiple lines per gene, use nrify_GOtable.pl prior to running this script.
...
write.csv(bestGOs, "Count_Symbiont_BP_bestGOs.csv")
